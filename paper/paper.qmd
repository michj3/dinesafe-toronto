...
```
The dataset was cleaned analyzed using the statistical programming software R [@citeR] and packages such as tidyverse [@tidy], ggplot2 [@ggplot2], kable [@kable], opendatatoronto [@opendatatoronto], dplyr [@dplyr], arrow [@arrow], vgam [@vgam], testthat [@testthat], car [@car], and broom [@broom]. 
